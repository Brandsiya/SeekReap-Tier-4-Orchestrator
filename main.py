...
async def verify_reap(request: Request):
    ...
    # Tier-0 simulation - guaranteed pass
    ...
    if DB_CONNECTED:
        try:
            ...
            db.commit()
            db.close()
            print(f"✅ Saved {cert_id} to database")
        except Exception as e:
...
<p>Send <strong>$0.01 USD</strong> to: paypal.me/youraccount/0.01</p>
